        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          <div className="bg-slate-900 rounded-[2.5rem] border border-slate-800 p-8 shadow-2xl relative overflow-hidden">
            ...
            <div className="relative z-10 flex flex-col items-center">
              <div className="w-40 h-40 bg-indigo-600/20 rounded-full flex items-center justify-center border-4 border-indigo-500/30 mb-6 shadow-2xl shadow-indigo-500/20">
